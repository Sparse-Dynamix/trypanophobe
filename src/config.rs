...
pub struct Config {
    ...
    pub wolf_max_length: usize,
    pub url_cache_ttl: Duration,
    pub url_cache_capacity: u64,
    pub max_markdown_chunks: usize,
...
impl Config {
    pub fn from_env() -> Self {
        ...
        Self {
            ...
            wolf_max_length: env_usize("WOLF_MAX_LENGTH").max(64),
            url_cache_ttl: env_secs("URL_CACHE_TTL_SECS"),
            url_cache_capacity: env_u64("URL_CACHE_CAPACITY"),
            max_markdown_chunks: env_usize("MAX_MARKDOWN_CHUNKS"),
            chunk_max_chars: env_usize("CHUNK_MAX_CHARS"),
            models_base,
        }
    }
}
